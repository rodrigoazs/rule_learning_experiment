...
consts = {'movie':set(),'person':set(),'genre':set()}
types = {
...
color = {'person': 'green', 'movie': 'red', 'genre': 'yellow'}

#dataset = []
with open('../slipcover/others/imdb.pl') as f:
    for line in f:
...
# train model
model = Word2Vec(sentences, min_count=1, sg=0, workers=4)
...
#types_transfer = types.copy()
#words_transfer = list(words)
#result_transfer = result